...
SquircleMouth::SquircleMouth() : is_speaking_(false),
...
void SquircleMouth::setSpeaking(const bool speaking)
{
...
void SquircleMouth::draw(sf::RenderWindow &renderWindow, const float frame_delta_time)
{
    if (is_speaking_)
    {
